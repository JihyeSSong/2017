...
//     else can->SaveAs("img_ScalingPlot_FINAL.pdf");
        ...
        can->SaveAs("img_ScalingPlot_iterative.pdf");
        can->SaveAs("img_ScalingPlot_iterative.C");
    }
...
//     else can->SaveAs("img_ScalingPlot_FINAL.pdf");
        ...
        can->SaveAs("img_ScalingPlot_COURIER.pdf");
        can->SaveAs("img_ScalingPlot_COURIER.C");
