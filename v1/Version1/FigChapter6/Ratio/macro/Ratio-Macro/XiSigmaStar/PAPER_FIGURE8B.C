{
  ...
  frame->GetXaxis()->SetTitleOffset(1.25);
   ...
   frame->GetYaxis()->SetTitleOffset(1.0);
    ...
    TBox *box = new TBox(34.8,0.00167996/ppresults-syserror1,36.4,0.00167996/ppresults+syserror1);
    ...
    box->SetLineWidth(2);
    box->Draw();
    box = new TBox(22.7,0.00162774/ppresults-syserror2,23.7,0.00162774/ppresults+syserror2);
    ...
    box->SetLineWidth(2);
    box->Draw();
    box = new TBox(15.7,0.00139961/ppresults-syserror3,16.5,0.00139961/ppresults+syserror3);
    ...
    box->SetLineWidth(2);
    box->Draw();
    box = new TBox(6.9,0.00104581/ppresults-syserror4,7.3,0.00104581/ppresults+syserror4);
    ...
    gre->SetPointError(0,0.8,staterror1);
    gre->SetPoint(1,23.2,0.00162774/ppresults);
    gre->SetPointError(1,0.5,staterror2);
    gre->SetPoint(2,16.1,0.00139961/ppresults);
    gre->SetPointError(2,0.4,staterror3);
    gre->SetPoint(3,7.1,0.00104581/ppresults);
    gre->SetPointError(3,0.2,staterror4);
...
///
    ...
    gre->SetPointError(0,0.8,staterror11);
    gre->SetPoint(1,19.7,0.0056/sigmapp);
    gre->SetPointError(1,0.5,staterror22);
    gre->SetPoint(2,7.1,0.0044/sigmapp);
    gre->SetPointError(2,0.2,staterror33);
    ...
    gre->SetMarkerSize(1.5);
    gre->SetPoint(0,35.6,0.0056/sigmapp);
    gre->SetPointError(0,0.8,syserror11);
    gre->SetPoint(1,19.7,0.0056/sigmapp);
    gre->SetPointError(1,0.5,syserror22);
    gre->SetPoint(2,7.1,0.0044/sigmapp);
    gre->SetPointError(2,0.2,syserror33);
