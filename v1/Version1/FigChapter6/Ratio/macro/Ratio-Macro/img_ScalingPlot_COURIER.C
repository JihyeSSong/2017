...
//=========  (Thu Mar  2 17:03:42 2017) by ROOT version5.34/30
   TCanvas *can = new TCanvas("can", "can",1120,1600,600,533);
   gStyle->SetOptStat(0);
   ...
   TH1F *Graph_gr[6][0][0]25 = new TH1F("Graph_gr[6][0][0]25","Graph",100,0.3539,23.2391);
   Graph_gr[6][0][0]25->SetMinimum(0.5197952);
   Graph_gr[6][0][0]25->SetMaximum(1.463073);
   Graph_gr[6][0][0]25->SetDirectory(0);
   Graph_gr[6][0][0]25->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_gr[6][0][0]25->SetLineColor(ci);
   Graph_gr[6][0][0]25->GetXaxis()->SetLabelFont(42);
   Graph_gr[6][0][0]25->GetXaxis()->SetLabelOffset(-0.012);
   Graph_gr[6][0][0]25->GetXaxis()->SetLabelSize(0.05891884);
   Graph_gr[6][0][0]25->GetXaxis()->SetTitleSize(0.06481072);
   Graph_gr[6][0][0]25->GetXaxis()->SetTickLength(0.03652968);
   Graph_gr[6][0][0]25->GetXaxis()->SetTitleOffset(1.0075);
   Graph_gr[6][0][0]25->GetXaxis()->SetTitleFont(42);
   Graph_gr[6][0][0]25->GetYaxis()->SetLabelFont(42);
   Graph_gr[6][0][0]25->GetYaxis()->SetLabelOffset(0.01);
   Graph_gr[6][0][0]25->GetYaxis()->SetLabelSize(0.05891884);
   Graph_gr[6][0][0]25->GetYaxis()->SetTitleSize(0.06481072);
   Graph_gr[6][0][0]25->GetYaxis()->SetTitleOffset(1.305);
   Graph_gr[6][0][0]25->GetYaxis()->SetTitleFont(42);
   Graph_gr[6][0][0]25->GetZaxis()->SetLabelFont(42);
   Graph_gr[6][0][0]25->GetZaxis()->SetLabelSize(0.035);
   Graph_gr[6][0][0]25->GetZaxis()->SetTitleSize(0.035);
   Graph_gr[6][0][0]25->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_gr[6][0][0]25);
   ...
   TH1F *Graph_gr[6][0][2]26 = new TH1F("Graph_gr[6][0][2]26","Graph",100,0.1651,23.9119);
   Graph_gr[6][0][2]26->SetMinimum(0.4423734);
   Graph_gr[6][0][2]26->SetMaximum(1.497776);
   Graph_gr[6][0][2]26->SetDirectory(0);
   Graph_gr[6][0][2]26->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_gr[6][0][2]26->SetLineColor(ci);
   Graph_gr[6][0][2]26->GetXaxis()->SetLabelFont(42);
   Graph_gr[6][0][2]26->GetXaxis()->SetLabelOffset(-0.012);
   Graph_gr[6][0][2]26->GetXaxis()->SetLabelSize(0.05891884);
   Graph_gr[6][0][2]26->GetXaxis()->SetTitleSize(0.06481072);
   Graph_gr[6][0][2]26->GetXaxis()->SetTickLength(0.03652968);
   Graph_gr[6][0][2]26->GetXaxis()->SetTitleOffset(1.0075);
   Graph_gr[6][0][2]26->GetXaxis()->SetTitleFont(42);
   Graph_gr[6][0][2]26->GetYaxis()->SetLabelFont(42);
   Graph_gr[6][0][2]26->GetYaxis()->SetLabelOffset(0.01);
   Graph_gr[6][0][2]26->GetYaxis()->SetLabelSize(0.05891884);
   Graph_gr[6][0][2]26->GetYaxis()->SetTitleSize(0.06481072);
   Graph_gr[6][0][2]26->GetYaxis()->SetTitleOffset(1.305);
   Graph_gr[6][0][2]26->GetYaxis()->SetTitleFont(42);
   Graph_gr[6][0][2]26->GetZaxis()->SetLabelFont(42);
   Graph_gr[6][0][2]26->GetZaxis()->SetLabelSize(0.035);
   Graph_gr[6][0][2]26->GetZaxis()->SetTitleSize(0.035);
   Graph_gr[6][0][2]26->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_gr[6][0][2]26);
   ...
   TH1F *Graph_gr[7][0][0]29 = new TH1F("Graph_gr[7][0][0]29","Graph",100,1.426,18.946);
   Graph_gr[7][0][0]29->SetMinimum(0.4554605);
   Graph_gr[7][0][0]29->SetMaximum(1.821807);
   Graph_gr[7][0][0]29->SetDirectory(0);
   Graph_gr[7][0][0]29->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_gr[7][0][0]29->SetLineColor(ci);
   Graph_gr[7][0][0]29->GetXaxis()->SetLabelFont(42);
   Graph_gr[7][0][0]29->GetXaxis()->SetLabelOffset(-0.012);
   Graph_gr[7][0][0]29->GetXaxis()->SetLabelSize(0.05891884);
   Graph_gr[7][0][0]29->GetXaxis()->SetTitleSize(0.06481072);
   Graph_gr[7][0][0]29->GetXaxis()->SetTickLength(0.03652968);
   Graph_gr[7][0][0]29->GetXaxis()->SetTitleOffset(1.0075);
   Graph_gr[7][0][0]29->GetXaxis()->SetTitleFont(42);
   Graph_gr[7][0][0]29->GetYaxis()->SetLabelFont(42);
   Graph_gr[7][0][0]29->GetYaxis()->SetLabelOffset(0.01);
   Graph_gr[7][0][0]29->GetYaxis()->SetLabelSize(0.05891884);
   Graph_gr[7][0][0]29->GetYaxis()->SetTitleSize(0.06481072);
   Graph_gr[7][0][0]29->GetYaxis()->SetTitleOffset(1.305);
   Graph_gr[7][0][0]29->GetYaxis()->SetTitleFont(42);
   Graph_gr[7][0][0]29->GetZaxis()->SetLabelFont(42);
   Graph_gr[7][0][0]29->GetZaxis()->SetLabelSize(0.035);
   Graph_gr[7][0][0]29->GetZaxis()->SetTitleSize(0.035);
   Graph_gr[7][0][0]29->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_gr[7][0][0]29);
   ...
   TH1F *Graph_gr[7][0][2]30 = new TH1F("Graph_gr[7][0][2]30","Graph",100,1.2267,19.5183);
   Graph_gr[7][0][2]30->SetMinimum(0.4275618);
   Graph_gr[7][0][2]30->SetMaximum(1.833195);
   Graph_gr[7][0][2]30->SetDirectory(0);
   Graph_gr[7][0][2]30->SetStats(0);

   ci = TColor::GetColor("#000099");
   Graph_gr[7][0][2]30->SetLineColor(ci);
   Graph_gr[7][0][2]30->GetXaxis()->SetLabelFont(42);
   Graph_gr[7][0][2]30->GetXaxis()->SetLabelOffset(-0.012);
   Graph_gr[7][0][2]30->GetXaxis()->SetLabelSize(0.05891884);
   Graph_gr[7][0][2]30->GetXaxis()->SetTitleSize(0.06481072);
   Graph_gr[7][0][2]30->GetXaxis()->SetTickLength(0.03652968);
   Graph_gr[7][0][2]30->GetXaxis()->SetTitleOffset(1.0075);
   Graph_gr[7][0][2]30->GetXaxis()->SetTitleFont(42);
   Graph_gr[7][0][2]30->GetYaxis()->SetLabelFont(42);
   Graph_gr[7][0][2]30->GetYaxis()->SetLabelOffset(0.01);
   Graph_gr[7][0][2]30->GetYaxis()->SetLabelSize(0.05891884);
   Graph_gr[7][0][2]30->GetYaxis()->SetTitleSize(0.06481072);
   Graph_gr[7][0][2]30->GetYaxis()->SetTitleOffset(1.305);
   Graph_gr[7][0][2]30->GetYaxis()->SetTitleFont(42);
   Graph_gr[7][0][2]30->GetZaxis()->SetLabelFont(42);
   Graph_gr[7][0][2]30->GetZaxis()->SetLabelSize(0.035);
   Graph_gr[7][0][2]30->GetZaxis()->SetTitleSize(0.035);
   Graph_gr[7][0][2]30->GetZaxis()->SetTitleFont(42);
   gre->SetHistogram(Graph_gr[7][0][2]30);
